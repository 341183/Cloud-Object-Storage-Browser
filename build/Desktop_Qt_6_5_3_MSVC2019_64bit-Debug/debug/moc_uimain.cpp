...
static constexpr auto qt_meta_stringdata_CLASSUiMainENDCLASS = QtMocHelpers::stringData(
    "UiMain",
    "chanegStyle",
    "",
    "onbuttonclicked",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSUiMainENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSUiMainENDCLASS_t qt_meta_stringdata_CLASSUiMainENDCLASS = {
    {
        QT_MOC_LITERAL(0, 6),  // "UiMain"
        QT_MOC_LITERAL(7, 11),  // "chanegStyle"
        QT_MOC_LITERAL(19, 0),  // ""
...
void UiMain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &UiMain::chanegStyle; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
